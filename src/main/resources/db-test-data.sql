...
INSERT INTO users(name, password, email, roles, enabled) VALUES ('admin', '$2a$10$/65XVr5RZqq6fx4nUQRxpOmxgMhY21dYkikb2IxZCZ0hARJ9rG/di', 'admin@gmail.com', 'ROLE_EDITOR,ROLE_ADMIN', true);
